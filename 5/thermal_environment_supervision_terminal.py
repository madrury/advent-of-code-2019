...
DoIncreaseInstructionPointer = bool
DoHalt = bool
OpcodeReturn = Tuple[Program, DoIncreaseInstructionPointer, DoHalt]
...
def run(program: Program) -> Program:
    ...
    while not halt:
        ...
        program, increase_instruction_pointer, halt = operation(
...
def add(
    ...
    current_position: int) -> OpcodeReturn:
